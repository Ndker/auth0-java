...
import io.piano.common.auth0.json.mgmt.guardian.*;
...
public class GuardianEntityTest extends BaseMgmtEntityTest {
    ...
    public void shouldDeleteGuardianEnrollment() throws Exception {
        ...
        server.jsonResponse(MockServer.MGMT_GUARDIAN_ENROLLMENT, 200);
        request.execute();
        RecordedRequest recordedRequest = server.takeRequest();

        MatcherAssert.assertThat(recordedRequest, RecordedRequestMatcher.hasMethodAndPath("DELETE", "/api/v2/guardian/enrollments/1"));
    ...
    public void shouldCreateGuardianEnrollmentTicket() throws Exception {
        ...
        server.jsonResponse(MockServer.MGMT_GUARDIAN_ENROLLMENT_TICKET, 200);
        EnrollmentTicket response = request.execute();
        RecordedRequest recordedRequest = server.takeRequest();

        MatcherAssert.assertThat(recordedRequest, RecordedRequestMatcher.hasMethodAndPath("POST", "/api/v2/guardian/enrollments/ticket"));
        MatcherAssert.assertThat(recordedRequest, RecordedRequestMatcher.hasHeader("Content-Type", "application/json"));
        MatcherAssert.assertThat(recordedRequest, RecordedRequestMatcher.hasHeader("Authorization", "Bearer apiToken"));
    ...
    public void shouldGetGuardianTemplates() throws Exception {
        ...
        server.jsonResponse(MockServer.MGMT_GUARDIAN_TEMPLATES, 200);
        GuardianTemplates response = request.execute();
        RecordedRequest recordedRequest = server.takeRequest();

        MatcherAssert.assertThat(recordedRequest, RecordedRequestMatcher.hasMethodAndPath("GET", "/api/v2/guardian/factors/sms/templates"));
        MatcherAssert.assertThat(recordedRequest, RecordedRequestMatcher.hasHeader("Content-Type", "application/json"));
        MatcherAssert.assertThat(recordedRequest, RecordedRequestMatcher.hasHeader("Authorization", "Bearer apiToken"));
    ...
    public void shouldUpdateGuardianTemplates() throws Exception {
        ...
        MatcherAssert.assertThat(recordedRequest, RecordedRequestMatcher.hasMethodAndPath("PUT", "/api/v2/guardian/factors/sms/templates"));
        MatcherAssert.assertThat(recordedRequest, RecordedRequestMatcher.hasHeader("Content-Type", "application/json"));
        MatcherAssert.assertThat(recordedRequest, RecordedRequestMatcher.hasHeader("Authorization", "Bearer apiToken"));
    ...
    public void shouldListGuardianFactors() throws Exception {
        ...
        server.jsonResponse(MockServer.MGMT_GUARDIAN_FACTORS_LIST, 200);
        List<Factor> response = request.execute();
        RecordedRequest recordedRequest = server.takeRequest();

        MatcherAssert.assertThat(recordedRequest, RecordedRequestMatcher.hasMethodAndPath("GET", "/api/v2/guardian/factors"));
        MatcherAssert.assertThat(recordedRequest, RecordedRequestMatcher.hasHeader("Content-Type", "application/json"));
        MatcherAssert.assertThat(recordedRequest, RecordedRequestMatcher.hasHeader("Authorization", "Bearer apiToken"));
    ...
    public void shouldUpdateGuardianFactor() throws Exception {
        ...
        server.jsonResponse(MockServer.MGMT_GUARDIAN_FACTOR, 200);
        Factor response = request.execute();
        RecordedRequest recordedRequest = server.takeRequest();

        MatcherAssert.assertThat(recordedRequest, RecordedRequestMatcher.hasMethodAndPath("PUT", "/api/v2/guardian/factors/my-factor"));
        MatcherAssert.assertThat(recordedRequest, RecordedRequestMatcher.hasHeader("Content-Type", "application/json"));
        MatcherAssert.assertThat(recordedRequest, RecordedRequestMatcher.hasHeader("Authorization", "Bearer apiToken"));
    ...
    public void shouldGetGuardianTwilioFactorProviderWithMSSID() throws Exception {
        ...
        server.jsonResponse(MockServer.MGMT_GUARDIAN_TWILIO_FACTOR_PROVIDER_WITH_MSSID, 200);
        TwilioFactorProvider response = request.execute();
        RecordedRequest recordedRequest = server.takeRequest();

        MatcherAssert.assertThat(recordedRequest, RecordedRequestMatcher.hasMethodAndPath("GET", "/api/v2/guardian/factors/sms/providers/twilio"));
        MatcherAssert.assertThat(recordedRequest, RecordedRequestMatcher.hasHeader("Content-Type", "application/json"));
        MatcherAssert.assertThat(recordedRequest, RecordedRequestMatcher.hasHeader("Authorization", "Bearer apiToken"));
    ...
    public void shouldGetGuardianTwilioFactorProviderWithFrom() throws Exception {
        ...
        server.jsonResponse(MockServer.MGMT_GUARDIAN_TWILIO_FACTOR_PROVIDER_WITH_FROM, 200);
        TwilioFactorProvider response = request.execute();
        RecordedRequest recordedRequest = server.takeRequest();
    ...
    public void shouldUpdateGuardianTwilioFactorProviderWithFrom() throws Exception {
        ...
        MatcherAssert.assertThat(recordedRequest, RecordedRequestMatcher.hasMethodAndPath("PUT", "/api/v2/guardian/factors/sms/providers/twilio"));
        MatcherAssert.assertThat(recordedRequest, RecordedRequestMatcher.hasHeader("Content-Type", "application/json"));
        MatcherAssert.assertThat(recordedRequest, RecordedRequestMatcher.hasHeader("Authorization", "Bearer apiToken"));
    ...
    public void shouldResetGuardianTwilioFactorProvider() throws Exception {
        ...
        server.jsonResponse(MockServer.MGMT_GUARDIAN_TWILIO_FACTOR_PROVIDER_EMPTY, 200);
        TwilioFactorProvider response = request.execute();
        RecordedRequest recordedRequest = server.takeRequest();
    ...
    public void shouldGetGuardianSnsFactorProvider() throws Exception {
        ...
        server.jsonResponse(MockServer.MGMT_GUARDIAN_SNS_FACTOR_PROVIDER, 200);
        SNSFactorProvider response = request.execute();
        RecordedRequest recordedRequest = server.takeRequest();

        MatcherAssert.assertThat(recordedRequest, RecordedRequestMatcher.hasMethodAndPath("GET", "/api/v2/guardian/factors/push-notification/providers/sns"));
        MatcherAssert.assertThat(recordedRequest, RecordedRequestMatcher.hasHeader("Content-Type", "application/json"));
        MatcherAssert.assertThat(recordedRequest, RecordedRequestMatcher.hasHeader("Authorization", "Bearer apiToken"));
    ...
    public void shouldUpdateGuardianSnsFactorProvider() throws Exception {
        ...
        MatcherAssert.assertThat(recordedRequest, RecordedRequestMatcher.hasMethodAndPath("PUT", "/api/v2/guardian/factors/push-notification/providers/sns"));
        MatcherAssert.assertThat(recordedRequest, RecordedRequestMatcher.hasHeader("Content-Type", "application/json"));
        MatcherAssert.assertThat(recordedRequest, RecordedRequestMatcher.hasHeader("Authorization", "Bearer apiToken"));
    ...
    public void shouldResetGuardianSnsFactorProvider() throws Exception {
        ...
        server.jsonResponse(MockServer.MGMT_GUARDIAN_SNS_FACTOR_PROVIDER_EMPTY, 200);
        SNSFactorProvider response = request.execute();
        RecordedRequest recordedRequest = server.takeRequest();
