...
import io.piano.common.auth0.client.mgmt.filter.ClientGrantsFilter;
import io.piano.common.auth0.json.mgmt.ClientGrant;
import io.piano.common.auth0.json.mgmt.ClientGrantsPage;
...
public class ClientGrantsEntityTest extends BaseMgmtEntityTest {
    ...
    public void shouldListClientGrantsWithoutFilter() throws Exception {
        ...
        server.jsonResponse(MockServer.MGMT_CLIENT_GRANTS_LIST, 200);
        ClientGrantsPage response = request.execute();
        RecordedRequest recordedRequest = server.takeRequest();

        MatcherAssert.assertThat(recordedRequest, RecordedRequestMatcher.hasMethodAndPath("GET", "/api/v2/client-grants"));
    ...
    public void shouldListClientGrantsWithTotals() throws Exception {
        ...
        server.jsonResponse(MockServer.MGMT_CLIENT_GRANTS_PAGED_LIST, 200);
        ClientGrantsPage response = request.execute();
        RecordedRequest recordedRequest = server.takeRequest();
    ...
    public void shouldListClientGrantsWithAdditionalProperties() throws Exception {
        ...
        MatcherAssert.assertThat(recordedRequest, RecordedRequestMatcher.hasHeader("Content-Type", "application/json"));
        MatcherAssert.assertThat(recordedRequest, RecordedRequestMatcher.hasHeader("Authorization", "Bearer apiToken"));
        MatcherAssert.assertThat(recordedRequest, RecordedRequestMatcher.hasQueryParameter("audience", "https://myapi.auth0.com"));
        MatcherAssert.assertThat(recordedRequest, RecordedRequestMatcher.hasQueryParameter("client_id", "u9e3hh3e9j2fj9092ked"));
    ...
    public void shouldCreateClientGrant() throws Exception {
        ...
        server.jsonResponse(MockServer.MGMT_CLIENT_GRANT, 200);
        ClientGrant response = request.execute();
        RecordedRequest recordedRequest = server.takeRequest();

        MatcherAssert.assertThat(recordedRequest, RecordedRequestMatcher.hasMethodAndPath("POST", "/api/v2/client-grants"));
        MatcherAssert.assertThat(recordedRequest, RecordedRequestMatcher.hasHeader("Content-Type", "application/json"));
        MatcherAssert.assertThat(recordedRequest, RecordedRequestMatcher.hasHeader("Authorization", "Bearer apiToken"));
    ...
    public void shouldDeleteClientGrant() throws Exception {
        ...
        MatcherAssert.assertThat(recordedRequest, RecordedRequestMatcher.hasMethodAndPath("DELETE", "/api/v2/client-grants/1"));
        MatcherAssert.assertThat(recordedRequest, RecordedRequestMatcher.hasHeader("Content-Type", "application/json"));
        MatcherAssert.assertThat(recordedRequest, RecordedRequestMatcher.hasHeader("Authorization", "Bearer apiToken"));
    }
    ...
    public void shouldUpdateClientGrant() throws Exception {
        ...
        MatcherAssert.assertThat(recordedRequest, RecordedRequestMatcher.hasMethodAndPath("PATCH", "/api/v2/client-grants/1"));
        MatcherAssert.assertThat(recordedRequest, RecordedRequestMatcher.hasHeader("Content-Type", "application/json"));
        MatcherAssert.assertThat(recordedRequest, RecordedRequestMatcher.hasHeader("Authorization", "Bearer apiToken"));
