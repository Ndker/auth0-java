...
public class AuthorizeUrlBuilderTest {
    ...
    public void shouldBuildValidAuthorizeUrlWithHttp() {
        ...
        MatcherAssert.assertThat(url, UrlMatcher.isUrl("http", "domain.auth0.com", "/authorize"));
    }
    ...
    public void shouldAddRedirectUri() {
        String url = AuthorizeUrlBuilder.newInstance(DOMAIN, CLIENT_ID, REDIRECT_URI).build();
        MatcherAssert.assertThat(url, UrlMatcher.hasQueryParameter("redirect_uri", REDIRECT_URI));
    }
    ...
    public void shouldNotEncodeTwiceTheRedirectUri() throws Exception {
        ...
        MatcherAssert.assertThat(url, UrlMatcher.encodedQueryContains("redirect_uri=" + encodedUrl));
    }
    ...
    public void shouldSetConnection() {
        String url = AuthorizeUrlBuilder.newInstance(DOMAIN, CLIENT_ID, REDIRECT_URI)
                ...
                .build();
        MatcherAssert.assertThat(url, UrlMatcher.hasQueryParameter("connection", "my-connection"));
    }
    ...
    public void shouldSetAudience() {
        String url = AuthorizeUrlBuilder.newInstance(DOMAIN, CLIENT_ID, REDIRECT_URI)
                ...
                .build();
        MatcherAssert.assertThat(url, UrlMatcher.hasQueryParameter("audience", "https://myapi.domain.com/users"));
    }
    ...
    public void shouldSetState() {
        String url = AuthorizeUrlBuilder.newInstance(DOMAIN, CLIENT_ID, REDIRECT_URI)
                ...
                .build();
        MatcherAssert.assertThat(url, UrlMatcher.hasQueryParameter("state", "1234567890"));
    }
    ...
    public void shouldSetScope() {
        String url = AuthorizeUrlBuilder.newInstance(DOMAIN, CLIENT_ID, REDIRECT_URI)
                ...
                .build();
        MatcherAssert.assertThat(url, UrlMatcher.hasQueryParameter("scope", "profile email contacts"));
    }
    ...
    public void shouldSetResponseType() {
        String url = AuthorizeUrlBuilder.newInstance(DOMAIN, CLIENT_ID, REDIRECT_URI)
                ...
                .build();
        MatcherAssert.assertThat(url, UrlMatcher.hasQueryParameter("response_type", "token id_token"));
    }
    ...
    public void shouldSetCustomParameter() {
        String url = AuthorizeUrlBuilder.newInstance(DOMAIN, CLIENT_ID, REDIRECT_URI)
                ...
                .build();
        MatcherAssert.assertThat(url, UrlMatcher.hasQueryParameter("name", "value"));
    }
    ...
    public void shouldAddOrganizationParameter() {
        String authUrl = AuthorizeUrlBuilder.newInstance(DOMAIN, CLIENT_ID, REDIRECT_URI)
            ...
            .build();
        MatcherAssert.assertThat(authUrl, UrlMatcher.hasQueryParameter("organization", "org_abc"));
    }
    ...
    public void shouldAddInvitationParameter() {
        String authUrl = AuthorizeUrlBuilder.newInstance(DOMAIN, CLIENT_ID, REDIRECT_URI)
            ...
            .build();
        MatcherAssert.assertThat(authUrl, UrlMatcher.hasQueryParameter("invitation", "invitation_123"));
    }
