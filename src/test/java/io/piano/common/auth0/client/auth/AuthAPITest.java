package io.piano.common.auth0.client.auth;

import io.piano.common.auth0.client.MockServer;
import io.piano.common.auth0.client.RecordedRequestMatcher;
import io.piano.common.auth0.client.UrlMatcher;
import io.piano.common.auth0.client.*;
import io.piano.common.auth0.exception.APIException;
import io.piano.common.auth0.json.auth.*;
import io.piano.common.auth0.net.*;
...
import static io.piano.common.auth0.client.UrlMatcher.isUrl;
...
public class AuthAPITest {
    ...
    public void shouldAcceptDomainWithNoScheme() {
        ...
        MatcherAssert.assertThat(api.getBaseUrl().toString(), UrlMatcher.isUrl("https", "me.something.com"));
    }
    ...
    public void shouldAcceptDomainWithHttpScheme() {
        ...
        assertThat(api.getBaseUrl(), is(notNullValue()));
        MatcherAssert.assertThat(api.getBaseUrl().toString(), UrlMatcher.isUrl("http", "me.something.com"));
    }
    ...
    public void shouldSetAuthorizeUrlBuilderDefaultValues() {
        ...
        MatcherAssert.assertThat(url, UrlMatcher.isUrl("https", "domain.auth0.com", "/authorize"));
        MatcherAssert.assertThat(url, UrlMatcher.hasQueryParameter("response_type", "code"));
        MatcherAssert.assertThat(url, UrlMatcher.hasQueryParameter("client_id", CLIENT_ID));
        MatcherAssert.assertThat(url, UrlMatcher.hasQueryParameter("redirect_uri", "https://domain.auth0.com/callback"));
        MatcherAssert.assertThat(url, UrlMatcher.hasQueryParameter("connection", null));
    }
    ...
    public void shouldSetLogoutUrlBuilderDefaultValues() {
        ...
        MatcherAssert.assertThat(url, UrlMatcher.isUrl("https", "domain.auth0.com", "/v2/logout"));
        MatcherAssert.assertThat(url, UrlMatcher.hasQueryParameter("client_id", null));
        MatcherAssert.assertThat(url, UrlMatcher.hasQueryParameter("returnTo", "https://my.domain.com/welcome"));
    }
    ...
    public void shouldCreateUserInfoRequest() throws Exception {
        ...
        server.jsonResponse(MockServer.AUTH_USER_INFO, 200);
        UserInfo response = request.execute();
        RecordedRequest recordedRequest = server.takeRequest();

        MatcherAssert.assertThat(recordedRequest, RecordedRequestMatcher.hasMethodAndPath("GET", "/userinfo"));
        MatcherAssert.assertThat(recordedRequest, RecordedRequestMatcher.hasHeader("Content-Type", "application/json"));
        MatcherAssert.assertThat(recordedRequest, RecordedRequestMatcher.hasHeader("Authorization", "Bearer accessToken"));
    ...
    public void shouldCreateResetPasswordRequest() throws Exception {
        ...
        server.jsonResponse(MockServer.AUTH_RESET_PASSWORD, 200);
        Void response = request.execute();
        RecordedRequest recordedRequest = server.takeRequest();

        MatcherAssert.assertThat(recordedRequest, RecordedRequestMatcher.hasMethodAndPath("POST", "/dbconnections/change_password"));
        MatcherAssert.assertThat(recordedRequest, RecordedRequestMatcher.hasHeader("Content-Type", "application/json"));
    ...
    public void shouldCreateSignUpRequestWithUsername() throws Exception {
        ...
        server.jsonResponse(MockServer.AUTH_SIGN_UP_USERNAME, 200);
        CreatedUser response = request.execute();
        RecordedRequest recordedRequest = server.takeRequest();

        MatcherAssert.assertThat(recordedRequest, RecordedRequestMatcher.hasMethodAndPath("POST", "/dbconnections/signup"));
        MatcherAssert.assertThat(recordedRequest, RecordedRequestMatcher.hasHeader("Content-Type", "application/json"));
    ...
    public void shouldCreateSignUpRequest() throws Exception {
        ...
        server.jsonResponse(MockServer.AUTH_SIGN_UP, 200);
        CreatedUser response = request.execute();
        RecordedRequest recordedRequest = server.takeRequest();
    ...
    public void shouldCreateLogInWithAuthorizationCodeGrantRequest() throws Exception {
        ...
        server.jsonResponse(MockServer.AUTH_TOKENS, 200);
        TokenHolder response = request.execute();
        RecordedRequest recordedRequest = server.takeRequest();

        MatcherAssert.assertThat(recordedRequest, RecordedRequestMatcher.hasMethodAndPath("POST", "/oauth/token"));
        MatcherAssert.assertThat(recordedRequest, RecordedRequestMatcher.hasHeader("Content-Type", "application/json"));
    ...
    public void shouldSetCustomHeaderWithPasswordlessRealmRequest() throws Exception {
        ...
        MatcherAssert.assertThat(recordedRequest, RecordedRequestMatcher.hasMethodAndPath("POST", "/oauth/token"));
        MatcherAssert.assertThat(recordedRequest, RecordedRequestMatcher.hasHeader("Content-Type", "application/json"));
        MatcherAssert.assertThat(recordedRequest, RecordedRequestMatcher.hasHeader("some-header", "some-value"));
    ...
    public void shouldCreateStartEmailPasswordlessFlowRequest() throws Exception {
        ...
        server.jsonResponse(MockServer.PASSWORDLESS_EMAIL_RESPONSE, 200);
        PasswordlessEmailResponse response = request.execute();
        RecordedRequest recordedRequest = server.takeRequest();

        MatcherAssert.assertThat(recordedRequest, RecordedRequestMatcher.hasMethodAndPath("POST", "/passwordless/start"));
        MatcherAssert.assertThat(recordedRequest, RecordedRequestMatcher.hasHeader("Content-Type", "application/json"));
    ...
    public void shouldCreateStartSmsPasswordlessFlowRequest() throws Exception {
        ...
        server.jsonResponse(MockServer.PASSWORDLESS_SMS_RESPONSE, 200);
    ...
    public void shouldCreateRevokeTokenRequest() throws Exception {
        ...
        MatcherAssert.assertThat(recordedRequest, RecordedRequestMatcher.hasMethodAndPath("POST", "/oauth/revoke"));
        MatcherAssert.assertThat(recordedRequest, RecordedRequestMatcher.hasHeader("Content-Type", "application/json"));
