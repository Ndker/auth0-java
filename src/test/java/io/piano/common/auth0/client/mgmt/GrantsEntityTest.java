...
import io.piano.common.auth0.client.mgmt.filter.GrantsFilter;
import io.piano.common.auth0.json.mgmt.Grant;
import io.piano.common.auth0.json.mgmt.GrantsPage;
...
public class GrantsEntityTest extends BaseMgmtEntityTest {
    ...
    public void shouldListGrantsWithoutFilter() throws Exception {
        ...
        server.jsonResponse(MockServer.MGMT_GRANTS_LIST, 200);
        GrantsPage response = request.execute();
        RecordedRequest recordedRequest = server.takeRequest();

        MatcherAssert.assertThat(recordedRequest, RecordedRequestMatcher.hasMethodAndPath("GET", "/api/v2/grants"));
        ...
        MatcherAssert.assertThat(recordedRequest, RecordedRequestMatcher.hasQueryParameter("user_id", "userId"));
    ...
    public void shouldListGrantsWithTotals() throws Exception {
        ...
        server.jsonResponse(MockServer.MGMT_GRANTS_PAGED_LIST, 200);
        GrantsPage response = request.execute();
        RecordedRequest recordedRequest = server.takeRequest();
    ...
    public void shouldDeleteGrantById() throws Exception {
        ...
        MatcherAssert.assertThat(recordedRequest, RecordedRequestMatcher.hasMethodAndPath("DELETE", "/api/v2/grants/1"));
        MatcherAssert.assertThat(recordedRequest, RecordedRequestMatcher.hasHeader("Content-Type", "application/json"));
        MatcherAssert.assertThat(recordedRequest, RecordedRequestMatcher.hasHeader("Authorization", "Bearer apiToken"));
    }
    ...
    public void shouldDeleteAllGrantsByUserId() throws Exception {
        ...
        MatcherAssert.assertThat(recordedRequest, RecordedRequestMatcher.hasMethodAndPath("DELETE", "/api/v2/grants"));
        MatcherAssert.assertThat(recordedRequest, RecordedRequestMatcher.hasQueryParameter("user_id", "userId"));
        MatcherAssert.assertThat(recordedRequest, RecordedRequestMatcher.hasHeader("Content-Type", "application/json"));
        MatcherAssert.assertThat(recordedRequest, RecordedRequestMatcher.hasHeader("Authorization", "Bearer apiToken"));
    }
