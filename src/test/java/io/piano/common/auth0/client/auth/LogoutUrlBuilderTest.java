...
public class LogoutUrlBuilderTest {
    ...
    public void shouldBuildValidLogoutUrlWithHttp() {
        ...
        MatcherAssert.assertThat(url, UrlMatcher.isUrl("http", "domain.auth0.com", "/v2/logout"));
    }
    ...
    public void shouldAddReturnToURL() {
        ...
        MatcherAssert.assertThat(url, UrlMatcher.hasQueryParameter("returnTo", RETURN_TO_URL));
    }
    ...
    public void shouldNotEncodeTwiceTheReturnToURL() throws Exception {
        ...
        MatcherAssert.assertThat(url, UrlMatcher.encodedQueryContains("returnTo=" + encodedUrl));
    }
    ...
    public void shouldUseFederated() {
        String url = LogoutUrlBuilder.newInstance(DOMAIN, CLIENT_ID, RETURN_TO_URL, true)
                .useFederated(true)
                .build();
        MatcherAssert.assertThat(url, UrlMatcher.hasQueryParameter("federated", ""));
    }
    ...
    public void shouldNotUseFederated() {
        String url = LogoutUrlBuilder.newInstance(DOMAIN, CLIENT_ID, RETURN_TO_URL, true)
                .useFederated(false)
                .build();
        MatcherAssert.assertThat(url, UrlMatcher.hasQueryParameter("federated", null));
    }
