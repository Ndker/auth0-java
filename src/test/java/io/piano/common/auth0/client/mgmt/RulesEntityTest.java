...
import io.piano.common.auth0.client.mgmt.filter.RulesFilter;
import io.piano.common.auth0.json.mgmt.Rule;
import io.piano.common.auth0.json.mgmt.RulesPage;
...
public class RulesEntityTest extends BaseMgmtEntityTest {
    ...
    public void shouldListRules() throws Exception {
        ...
        server.jsonResponse(MockServer.MGMT_RULES_LIST, 200);
        List<Rule> response = request.execute();
        RecordedRequest recordedRequest = server.takeRequest();

        MatcherAssert.assertThat(recordedRequest, RecordedRequestMatcher.hasMethodAndPath("GET", "/api/v2/rules"));
    ...
    public void shouldListRulesWithEnabled() throws Exception {
        ...
        MatcherAssert.assertThat(recordedRequest, RecordedRequestMatcher.hasHeader("Content-Type", "application/json"));
        MatcherAssert.assertThat(recordedRequest, RecordedRequestMatcher.hasHeader("Authorization", "Bearer apiToken"));
        MatcherAssert.assertThat(recordedRequest, RecordedRequestMatcher.hasQueryParameter("enabled", "true"));
    ...
    public void shouldListRulesWithTotals() throws Exception {
        ...
        server.jsonResponse(MockServer.MGMT_RULES_PAGED_LIST, 200);
        RulesPage response = request.execute();
        RecordedRequest recordedRequest = server.takeRequest();
    ...
    public void shouldGetRule() throws Exception {
        ...
        server.jsonResponse(MockServer.MGMT_RULE, 200);
        Rule response = request.execute();
        RecordedRequest recordedRequest = server.takeRequest();

        MatcherAssert.assertThat(recordedRequest, RecordedRequestMatcher.hasMethodAndPath("GET", "/api/v2/rules/1"));
        MatcherAssert.assertThat(recordedRequest, RecordedRequestMatcher.hasHeader("Content-Type", "application/json"));
        MatcherAssert.assertThat(recordedRequest, RecordedRequestMatcher.hasHeader("Authorization", "Bearer apiToken"));
    ...
    public void shouldCreateRule() throws Exception {
        ...
        MatcherAssert.assertThat(recordedRequest, RecordedRequestMatcher.hasMethodAndPath("POST", "/api/v2/rules"));
        MatcherAssert.assertThat(recordedRequest, RecordedRequestMatcher.hasHeader("Content-Type", "application/json"));
        MatcherAssert.assertThat(recordedRequest, RecordedRequestMatcher.hasHeader("Authorization", "Bearer apiToken"));
    ...
    public void shouldDeleteRule() throws Exception {
        ...
        MatcherAssert.assertThat(recordedRequest, RecordedRequestMatcher.hasMethodAndPath("DELETE", "/api/v2/rules/1"));
        MatcherAssert.assertThat(recordedRequest, RecordedRequestMatcher.hasHeader("Content-Type", "application/json"));
        MatcherAssert.assertThat(recordedRequest, RecordedRequestMatcher.hasHeader("Authorization", "Bearer apiToken"));
    }
    ...
    public void shouldUpdateRule() throws Exception {
        ...
        MatcherAssert.assertThat(recordedRequest, RecordedRequestMatcher.hasMethodAndPath("PATCH", "/api/v2/rules/1"));
        MatcherAssert.assertThat(recordedRequest, RecordedRequestMatcher.hasHeader("Content-Type", "application/json"));
        MatcherAssert.assertThat(recordedRequest, RecordedRequestMatcher.hasHeader("Authorization", "Bearer apiToken"));
