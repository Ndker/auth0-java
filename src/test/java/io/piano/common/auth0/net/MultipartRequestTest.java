...
import io.piano.common.auth0.exception.RateLimitException;
import io.piano.common.auth0.json.auth.TokenHolder;
...
public class MultipartRequestTest {
    ...
    public void shouldAddMultipleParts() throws Exception {
        ...
        File fileValue = new File(MockServer.MULTIPART_SAMPLE);
    ...
    public void shouldParseJSONErrorResponseWithErrorDescription() throws Exception {
        MultipartRequest<List> request = new MultipartRequest<>(client, server.getBaseUrl(), "POST", listType);
        request.addPart("non_empty", "body");
        server.jsonResponse(MockServer.AUTH_ERROR_WITH_ERROR_DESCRIPTION, 400);
        Exception exception = null;
        try {
            request.execute();
            server.takeRequest();
    ...
    public void shouldParseJSONErrorResponseWithError() throws Exception {
        MultipartRequest<List> request = new MultipartRequest<>(client, server.getBaseUrl(), "POST", listType);
        request.addPart("non_empty", "body");
        server.jsonResponse(MockServer.AUTH_ERROR_WITH_ERROR, 400);
        Exception exception = null;
        try {
            request.execute();
            server.takeRequest();
    ...
    public void shouldParseJSONErrorResponseWithDescriptionAndExtraProperties() throws Exception {
        MultipartRequest<List> request = new MultipartRequest<>(client, server.getBaseUrl(), "POST", listType);
        request.addPart("non_empty", "body");
        server.jsonResponse(MockServer.AUTH_ERROR_WITH_DESCRIPTION_AND_EXTRA_PROPERTIES, 400);
        Exception exception = null;
        try {
            request.execute();
            server.takeRequest();
    ...
    public void shouldParseJSONErrorResponseWithDescription() throws Exception {
        MultipartRequest<List> request = new MultipartRequest<>(client, server.getBaseUrl(), "POST", listType);
        request.addPart("non_empty", "body");
        server.jsonResponse(MockServer.AUTH_ERROR_WITH_DESCRIPTION, 400);
        Exception exception = null;
        try {
            request.execute();
            server.takeRequest();
    ...
    public void shouldParseJSONErrorResponseWithMessage() throws Exception {
        MultipartRequest<List> request = new MultipartRequest<>(client, server.getBaseUrl(), "POST", listType);
        request.addPart("non_empty", "body");
        server.jsonResponse(MockServer.MGMT_ERROR_WITH_MESSAGE, 400);
        Exception exception = null;
        try {
            request.execute();
            server.takeRequest();
    ...
    public void shouldParsePlainTextErrorResponse() throws Exception {
        MultipartRequest<List> request = new MultipartRequest<>(client, server.getBaseUrl(), "POST", listType);
        request.addPart("non_empty", "body");
        server.textResponse(MockServer.AUTH_ERROR_PLAINTEXT, 400);
        Exception exception = null;
        try {
            request.execute();
            server.takeRequest();
