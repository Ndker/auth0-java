...
package io.piano.common.auth0.json.mgmt.tickets;
...
import io.piano.common.auth0.client.mgmt.TicketsEntity;

/**
 * Class that represents an Auth0 Email Verification Ticket object. Related to the {@link TicketsEntity} entity.
 */
